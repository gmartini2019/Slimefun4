...
public final class SlimefunItems {
    ...
    public static final SlimefunItemStack ENDER_WAND = new SlimefunItemStack("ENDER_WAND", Material.BLAZE_ROD, "&cEnder Wand", "&5Soul-Rend", "", "&Send any mob of your choosing to a random location. Will it be grassland, or a pit of lava... ?!");
    static {
